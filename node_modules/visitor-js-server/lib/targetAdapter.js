...
var payloadToTargetKeyMap = {
    ...
    PUUID: "mboxAAMDPUUID",
    PID: "mboxAAMDPID",
    authStateId: "vst.authStateId",
    authState: "vst.authState.authState"
};
...
function createTargetSchema() {
    return {
        ...
        "mboxParameters": {
            "mboxAAMB": undefined,
            "mboxMCGLH": undefined,
            "mboxAAMDPUUID": undefined,
            "mboxAAMDPID": undefined,
            "vst.authStateId": undefined,
            "vst.authState.authState": undefined,
...
function renameKeys(obj, keysMap) {
    return Object.assign.apply(Object, [{}].concat(_toConsumableArray(Object.keys(obj).map(function (key) {
        return _defineProperty({}, keysMap[key], obj[key]);
    }))));
}
...
// Target adapter will output an object in the format of `targetSchema`.
function adapt(obj) {
