...
function populateCustomerIDs(schema, _ref2) {
    ...
    (0, _utils.forEachKey)(customerIDs, function (idKey) {
        ...
        if ((0, _utils.isObject)(idValue)) {
            (0, _utils.forEachKey)(idValue, function (key) {
...
function populate(schema, objWithValues) {
    Object.keys(schema).forEach(function (key) {
        if ((0, _utils.isObject)(schema[key])) {
    ...
    return (0, _utils.filterBadProps)(schema);
}
