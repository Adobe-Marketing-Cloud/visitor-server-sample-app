...
const visitor = new Visitor("1234567891011@AdobeOrg");
...
test("Calling getState:", (t) => {
    ...
    t.ok(state["1234567891011@AdobeOrg"], "State should have be partitioned by OrgID");
    t.ok(state["1234567891011@AdobeOrg"].sdid, "State should contain a SDID");
    t.equal(state["1234567891011@AdobeOrg"].consumerID, "payload:test-customer-A");
    t.end();
});
